...
style="TEXT-ALIGN: right" align=right>�&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label id="Label7" runat="server" Visible="False" ForeColor="ControlDarkDark" Font-Size="Small" Font-Bold="True" AssociatedControlID="TxtUserName">Contrase�a Anterior:</asp:Label>&nbsp;
</TD><TD 
...
style="TEXT-ALIGN: right" align=right>�&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label id="PasswordLabel" runat="server" ForeColor="ControlDarkDark" Font-Size="Small" Font-Bold="True" AssociatedControlID="TxtPassword">* Contrase�a:</asp:Label></TD><TD 
style="TEXT-ALIGN: left"><asp:TextBox id="TxtPassword" runat="server" CssClass="TxtStyle" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator id="PasswordRequired" runat="server" ToolTip="La contrase�a es obligatoria." ValidationGroup="CreateUserWizard1" ErrorMessage="La contrase�a es obligatoria." ControlToValidate="TxtPassword">*</asp:RequiredFieldValidator><Ajax:passwordstrength id="PasswordStrength2" runat="server" HelpHandlePosition="BelowLeft" textstrengthdescriptions="Very Poor;Weak;Average;Strong;Excellent" targetcontrolid="TxtPassword" strengthstyles="BarIndicator_TextBox2_weak;BarIndicator_TextBox2_average;BarIndicator_TextBox2_good" strengthindicatortype="BarIndicator" requiresupperandlowercasecharacters="true" preferredpasswordlength="5" minimumsymbolcharacters="1" minimumnumericcharacters="1" helpstatuslabelid="TextBox2_HelpLabel" barbordercssclass="BarBorder_TextBox2"></Ajax:passwordstrength> 
<asp:Label id="TextBox2_HelpLabel" runat="server" CssClass="heading"></asp:Label></TD></TR><TR><TD style="TEXT-ALIGN: right" 
align=right>�&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label id="ConfirmPasswordLabel" runat="server" ForeColor="ControlDarkDark" Font-Size="Small" Font-Bold="True" AssociatedControlID="TxtConfirmPassword">* Confirmar contrase�a:</asp:Label></TD><TD 
style="TEXT-ALIGN: left"><asp:TextBox id="TxtConfirmPassword" runat="server" CssClass="TxtStyle" TextMode="Password"></asp:TextBox> 
<asp:RequiredFieldValidator id="ConfirmPasswordRequired" runat="server" ToolTip="Confirmar contrase�a es obligatorio." ValidationGroup="CreateUserWizard1" ErrorMessage="Confirmar contrase�a es obligatorio." ControlToValidate="TxtConfirmPassword">*</asp:RequiredFieldValidator> 
</TD></TR><TR><TD 
style="TEXT-ALIGN: right" align=right>�&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label id="EmailLabel" runat="server" ForeColor="ControlDarkDark" Font-Size="Small" Font-Bold="True" AssociatedControlID="TxtEmail">* Correo electr�nico:</asp:Label></TD><TD 
style="TEXT-ALIGN: left"><asp:TextBox id="TxtEmail" runat="server" CssClass="TxtStyle"></asp:TextBox> 
<asp:RequiredFieldValidator id="EmailRequired" runat="server" ToolTip="El correo electr�nico es obligatorio." ValidationGroup="CreateUserWizard1" ErrorMessage="El correo electr�nico es obligatorio." ControlToValidate="TxtEmail">*</asp:RequiredFieldValidator> 
</TD></TR><TR><TD 
style="FONT-WEIGHT: bold; COLOR: white; HEIGHT: 20px; BACKGROUND-COLOR: #507cd1" 
align=center colSpan=2><SPAN 
...
<asp:TextBox id="TxtDependencia" runat="server" Width="350px" CssClass="TxtAutoComplete"></asp:TextBox><asp:RequiredFieldValidator id="DependneciaRequired" runat="server" ToolTip="El correo electr�nico es obligatorio." ValidationGroup="CreateUserWizard1" ErrorMessage="El correo electr�nico es obligatorio." ControlToValidate="TxtDependencia">*</asp:RequiredFieldValidator></TD></TR>
    <tr>
